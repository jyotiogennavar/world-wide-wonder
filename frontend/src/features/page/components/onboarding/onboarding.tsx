...
import {sanityStudioUrl} from '@/config/env'
  ...
  return (
    <div className="max-w-2xl mx-auto grid grid-flow-row gap-6 py-12 text-center bg-brand text-white rounded-lg p-8">
      ...
      <OnboardingMessage
        ...
        link={{
          title: 'Create Post',
          href: `${sanityStudioUrl}/structure/intent/create/template=post;type=post;path=title`,
        }}
        type="post"
        path="title"
      />
  ...
  return (
    <div className="max-w-2xl mx-auto grid grid-flow-row gap-6 py-12 text-center bg-brand text-white rounded-lg p-8">
      ...
      <OnboardingMessage
        ...
        link={{
          title: 'Create Page',
          href: `${sanityStudioUrl}/structure/intent/create/template=page;type=page;path=name`,
        }}
        type="page"
        path="name"
      />
